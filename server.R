shinyServer(function(input, output, session){
  ...
  output$DT4 <- DT::renderDataTable(
    DT::datatable(data()$ncGdata,
                  ...
                  caption = htmltools::tags$caption(
                    style = 'caption-side: top; text-align: center;',
                    htmltools::h4('Gene Set Analysis tools for ncRNA data')
                  ),
                  escape = FALSE,
                  extensions = c('AutoFill','Buttons'),
                  selection = list(target = 'row'),
  ...
  output$DT5 <- DT::renderDataTable(
    DT::datatable(data()$MSdata,
                  ...
                  caption = htmltools::tags$caption(
                    style = 'caption-side: top; text-align: center;',
                    htmltools::h4('Gene Set Analysis tools for MS-based data')
                  ),
                  escape = FALSE,
                  extensions = c('AutoFill','Buttons'),
                  selection = list(target = 'row'),
  ...
  output$DT6 <- DT::renderDataTable(
    DT::datatable(data()$MGdata,
                  ...
                  caption = htmltools::tags$caption(
                    style = 'caption-side: top; text-align: center;',
                    htmltools::h4('Metagenomics Gene Set Analysis tools')
                  ),
                  escape = FALSE,
                  extensions = c('AutoFill','Buttons'),
                  selection = list(target = 'row'),
  ...
  output$DT7 <- DT::renderDataTable(
    DT::datatable(data()$Indata,
                  ...
                  caption = htmltools::tags$caption(
                    style = 'caption-side: top; text-align: center;',
                    htmltools::h4('Integromics Gene Set Analysis tools')
                  ),
                  escape = FALSE,
                  extensions = c('AutoFill','Buttons'),
                  selection = list(target = 'row'),
